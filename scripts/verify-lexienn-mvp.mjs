...
function verifyFilesystem() {
  ...
  const keyModules = [
    ...
    "lib/conversation/conversationTurn.ts",
    "components/translator/CameraTranslatorView.tsx",
    "components/lens/LensView.tsx",
    "components/lens/LensModeTabs.tsx",
    "components/lens/TapToDefineSheet.tsx",
    "lib/lens/lensTypes.ts",
    "lib/lens/documentIntelligence.ts",
    "components/translator/TranslatorCameraRedirect.tsx",
    ...
    "lib/languages/nationalLanguages.ts",
    "lib/languages/spokenLanguageDetection.ts",
    "components/settings/SettingsView.tsx",
    "components/offline/OfflineView.tsx",
    "components/offline/SmartPackBuilder.tsx",
    ...
    "components/library/VocabularyReviewCard.tsx",
    "lib/storage/vocabularyReviewStorage.ts",
    "lib/storage/learningTypes.ts",
    "lib/capabilities/contracts.ts",
    "lib/config/featureFlags.ts",
    "lib/offline/smartPackBuilder.ts",
    "lib/offline/offlineCapabilities.ts",
...
function printManualChecklist() {
  ...
  const items = [
    ...
    "Open /lens, upload an image, extract text, translate",
    "Open /translator and confirm Open Lens link; no Camera tab",
    "Open /translator → Open Conversation; confirm Person A/B panels and tap-to-speak",
    "Open /conversation Big Screen and confirm large translated text",
